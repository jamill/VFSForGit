...
namespace GVFS.PerfProfiling
{
    internal class ProfilingEnvironment
    {
        ...
        private GVFSEnlistment CreateEnlistment(string enlistmentRootPath)
        {
            ...
            string hooksPath = ProcessHelper.WhereDirectory(GVFSPlatform.Instance.Constants.ProgramLocaterCommand, GVFSPlatform.Instance.Constants.GVFSHooksExecutableName);
